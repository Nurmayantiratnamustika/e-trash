        ...
        <div class="row">
          ...
          <div class="col-lg-5 pl-lg-5 ml-auto">
            <div class="mb-5">
              ...
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Buy Product</button>
            ...
            <div class="mb-5">
              ...
              <div class="mt-5">
             <iframe width="100%"  class="w-50 mb-2 rounded-circle"  frameborder="0" scrolling="no" marginheight="0" 
